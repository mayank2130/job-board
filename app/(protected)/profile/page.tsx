  ...
  return (
    <div className="w-full mx-auto px-64 mt-12 bg-white">
      ...
      <div className="flex flex-col mb-8 shadow-lg p-7 rounded-md gap-10">
        <AboutSection data={profileData} onChange={handleChange} />
        <SocialProfilesSection data={profileData} onChange={handleChange} />
        <WorkExperienceSection data={profileData} onChange={handleChange} />
        <SkillsSection data={profileData} onChange={handleChange} />
        <AchievementsSection data={profileData} onChange={handleChange} />
      </div>
      {hasChanges && (
        <Button
          onClick={handleSave}
